...
/*
    ...
    LinkedList集合的特点:
        ...
        - public E pop():从此列表所表示的堆栈处弹出一个元素。 (等效于 removeFirst)
         ...
         注：(to self)
            在Java里别用push 和 pop，容易和js的数组方法混淆，这两语言的pop,push位置不一样
...
public class Demo02LinkedList {
    ...
    private static void show03() {
        ...
        // String first = linked.pop(); // ← 容易和JS中的pop位置混淆(JS移除数组的末尾,Java移除开头, 别用)
    ...
    private static void show01() {
        ...
        //public void addFirst(E e):将指定元素插入此列表的开头。
        linked.addFirst("www");
        // linked.push("www"); // ← JS的push位置和Java的push位置是反的 (JS push在末尾, Java push在开头，易混淆，别用)
